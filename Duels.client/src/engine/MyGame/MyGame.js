...
function MyGame() {
    this.kMinionSprite = "src/assets/img/minion_sprite.png";
    this.kMinionSpriteNormal = "src/assets/img/minion_sprite_normal.png";
    this.kBg = "src/assets/img/bg.png";
    this.kBgNormal = "src/assets/img/bg_normal.png";
    this.kBgLayer = "src/assets/img/bgLayer.png";
    this.kBgLayerNormal = "src/assets/img/bgLayer_normal.png";
